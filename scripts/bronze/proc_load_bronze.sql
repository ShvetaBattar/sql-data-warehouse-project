/*
===============================================================================
Stored Procedure: Loading a Bronze Layer (From Sources ->  To Bronze Layer Tables)
===============================================================================
Script Purpose:
...
BEGIN
 DECLARE @start_time DATETIME, @end_time DATETIME, @batch_start_time DATETIME, @batch_end_time DATETIME; --variables--
 BEGIN TRY
 ...
 PRINT '----------------------------------------------';
   ...
   PRINT'>>Inserting Data Into Table:bronze.crm_px_cat_g1v2';
...
--Execution Statement for Stored Procedure---  
EXEC bronze.load_bronze;
